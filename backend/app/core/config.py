...
class BaseAppSettings(BaseSettings):
    ...
    # Use MAX_UPLOAD_SIZE_MB from env (already set to 100 in .env file)
    MAX_UPLOAD_SIZE: int = Field(default_factory=lambda: int(os.getenv("MAX_UPLOAD_SIZE_MB", "100")) * 1024 * 1024)
